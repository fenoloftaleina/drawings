...
var G__22173 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__22173;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__22174 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22174,ch);
...
if(("\\" === ch__$1)){
var ch_22175__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_22175__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_22175__$2);
} else {
}

var G__22176 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__22176;
continue;
}
}
...
var vec__22184 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22184,(0),null);
var start_column = cljs.core.nth.call(null,vec__22184,(1),null);
...
var G__22187 = cljs.core.conj_BANG_.call(null,a,form);
a = G__22187;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__22188 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__22189 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__22189;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__22188;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__22190 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22190,(0),null);
var start_column = cljs.core.nth.call(null,vec__22190,(1),null);
...
var vec__22193 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22193,(0),null);
var end_column = cljs.core.nth.call(null,vec__22193,(1),null);
...
var vec__22196 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22196,(0),null);
var start_column = cljs.core.nth.call(null,vec__22196,(1),null);
...
var vec__22199 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22199,(0),null);
var end_column = cljs.core.nth.call(null,vec__22199,(1),null);
...
var sb = (function (){var G__22208 = (new goog.string.StringBuffer());
G__22208.append(initch);
...
var G__22210 = (function (){var G__22209 = sb;
G__22209.append(ch);
...
switch (G__22214) {
case "\\":
var G__22218 = (function (){var G__22215 = sb;
G__22215.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__22215;
})();
var G__22219 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__22218;
ch = G__22219;
continue;
...
break;
default:
var G__22220 = (function (){var G__22216 = sb;
G__22216.append(ch);

return G__22216;
})();
var G__22221 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__22220;
ch = G__22221;
continue;
...
var vec__22222 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22222,(0),null);
var end_column = cljs.core.nth.call(null,vec__22222,(1),null);
...
var vec__22225 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22225,(0),null);
var column = cljs.core.nth.call(null,vec__22225,(1),null);
...
var vec__22230 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22230,(0),null);
var column = cljs.core.nth.call(null,vec__22230,(1),null);
...
var G__22246 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__22246,true,null,opts,pending_forms);
...
var G__22247 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__22247)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__22247)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__22247)){
...
var _STAR_suppress_read_STAR__orig_val__22248 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__22249 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__22249;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__22248;
}});
...
var G__22250 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__22250,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__22250,rdr,first_line);
...
var G__22254 = matched;
var G__22255 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__22254;
finished = G__22255;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__22256 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__22257 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__22257;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__22256;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__22258 = cljs.tools.reader.arg_env;
var arg_env_temp_val__22259 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__22259;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__22260 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22260,"(");
...
var G__22261 = (i + (1));
var G__22262 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__22258;
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__22263 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__22263);
...
var G__22266 = cljs.core.next.call(null,s);
var G__22267 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__22266;
key_vals = G__22267;
continue;
} else {
...
var gensym_env_orig_val__22271 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__22272 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__22272;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__22271;
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__22273 = token;
var G__22273__$1 = (((G__22273 == null))?null:cljs.core.subs.call(null,G__22273,(1)));
var G__22273__$2 = (((G__22273__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22273__$1));
var G__22273__$3 = (((G__22273__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22273__$2));
var G__22273__$4 = (((G__22273__$3 == null))?null:cljs.core.symbol.call(null,G__22273__$3));
if((G__22273__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__22273__$4);
}
})():(function (){var G__22274 = token;
var G__22274__$1 = (((G__22274 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22274));
if((G__22274__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22274__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__22285,reader){
...
var opts = map__22286__$1;
var eof = cljs.core.get.call(null,map__22286__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___22294 = arguments.length;
var i__4731__auto___22295 = (0);
while(true){
if((i__4731__auto___22295 < len__4730__auto___22294)){
args__4736__auto__.push((arguments[i__4731__auto___22295]));

var G__22296 = (i__4731__auto___22295 + (1));
i__4731__auto___22295 = G__22296;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq22292){
var G__22293 = cljs.core.first.call(null,seq22292);
var seq22292__$1 = cljs.core.next.call(null,seq22292);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22293,seq22292__$1);
});


//# sourceMappingURL=reader.js.map?rel=1571951935305
