...
var vec__21336 = axis;
var a_x = cljs.core.nth.call(null,vec__21336,(0),null);
var a_y = cljs.core.nth.call(null,vec__21336,(1),null);
var a_z = cljs.core.nth.call(null,vec__21336,(2),null);
var vec__21339 = v;
var x = cljs.core.nth.call(null,vec__21339,(0),null);
var y = cljs.core.nth.call(null,vec__21339,(1),null);
var z = cljs.core.nth.call(null,vec__21339,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__21342,p__21343){
var vec__21344 = p__21342;
var u1 = cljs.core.nth.call(null,vec__21344,(0),null);
var u2 = cljs.core.nth.call(null,vec__21344,(1),null);
var u3 = cljs.core.nth.call(null,vec__21344,(2),null);
var vec__21347 = p__21343;
var v1 = cljs.core.nth.call(null,vec__21347,(0),null);
var v2 = cljs.core.nth.call(null,vec__21347,(1),null);
var v3 = cljs.core.nth.call(null,vec__21347,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__21350_SHARP_){
return (p1__21350_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__21351_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__21352_SHARP_,angle_lr),angle_ud);
...
var map__21354 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__21354__$1 = (((((!((map__21354 == null))))?(((((map__21354.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21354.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21354):map__21354);
var up = cljs.core.get.call(null,map__21354__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__21354__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5733__auto__ = (function (){var pred__21356 = cljs.core._EQ_;
var expr__21357 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__21356.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__21357))){
return straight;
} else {
if(cljs.core.truth_(pred__21356.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__21357))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__21356.call(null,quil.middlewares.navigation_3d.space,expr__21357))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__21356.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__21357))){
return up;
} else {
if(cljs.core.truth_(pred__21356.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__21357))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__21356.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__21357))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5733__auto__,map__21354,map__21354__$1,up,straight){
return (function (p1__21353_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__21353_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5733__auto__,map__21354,map__21354__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__21359_SHARP_);
});})(initial_state))
);
});
/**
...
var map__21360_21371 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__21360_21372__$1 = (((((!((map__21360_21371 == null))))?(((((map__21360_21371.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21360_21371.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21360_21371):map__21360_21371);
var vec__21361_21373 = cljs.core.get.call(null,map__21360_21372__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_21374 = cljs.core.nth.call(null,vec__21361_21373,(0),null);
var c_y_21375 = cljs.core.nth.call(null,vec__21361_21373,(1),null);
var c_z_21376 = cljs.core.nth.call(null,vec__21361_21373,(2),null);
var vec__21364_21377 = cljs.core.get.call(null,map__21360_21372__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_21378 = cljs.core.nth.call(null,vec__21364_21377,(0),null);
var u_y_21379 = cljs.core.nth.call(null,vec__21364_21377,(1),null);
var u_z_21380 = cljs.core.nth.call(null,vec__21364_21377,(2),null);
var vec__21367_21381 = cljs.core.get.call(null,map__21360_21372__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_21382 = cljs.core.nth.call(null,vec__21367_21381,(0),null);
var p_y_21383 = cljs.core.nth.call(null,vec__21367_21381,(1),null);
var p_z_21384 = cljs.core.nth.call(null,vec__21367_21381,(2),null);
quil.core.camera.call(null,p_x_21382,p_y_21383,p_z_21384,(p_x_21382 + c_x_21374),(p_y_21383 + c_y_21375),(p_z_21384 + c_z_21376),u_x_21378,u_y_21379,u_z_21380);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1571951934127
