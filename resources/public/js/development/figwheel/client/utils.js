...
return (new CustomEvent(event_name,(function (){var obj27087 = ({"detail":data});
return obj27087;
})()));
} else {
...
var f = (function (){var pred__27094 = cljs.core._EQ_;
var expr__27095 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27094.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27095))){
return ((function (pred__27094,expr__27095){
return (function (p1__27088_SHARP_){
return console.warn(p1__27088_SHARP_);
});
;})(pred__27094,expr__27095))
} else {
if(cljs.core.truth_(pred__27094.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27095))){
return ((function (pred__27094,expr__27095){
return (function (p1__27089_SHARP_){
return console.debug(p1__27089_SHARP_);
});
;})(pred__27094,expr__27095))
} else {
if(cljs.core.truth_(pred__27094.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27095))){
return ((function (pred__27094,expr__27095){
return (function (p1__27090_SHARP_){
return console.error(p1__27090_SHARP_);
});
;})(pred__27094,expr__27095))
} else {
return ((function (pred__27094,expr__27095){
return (function (p1__27091_SHARP_){
return console.log(p1__27091_SHARP_);
});
;})(pred__27094,expr__27095))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27098){
...
var opts = map__27099__$1;
var eval_fn = cljs.core.get.call(null,map__27099__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27101_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27103,(0),null);
var v = cljs.core.nth.call(null,vec__27103,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1571951937816
