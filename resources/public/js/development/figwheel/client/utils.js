...
return (new CustomEvent(event_name,(function (){var obj23414 = ({"detail":data});
return obj23414;
})()));
} else {
...
var f = (function (){var pred__23421 = cljs.core._EQ_;
var expr__23422 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__23421.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__23422))){
return ((function (pred__23421,expr__23422){
return (function (p1__23415_SHARP_){
return console.warn(p1__23415_SHARP_);
});
;})(pred__23421,expr__23422))
} else {
if(cljs.core.truth_(pred__23421.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__23422))){
return ((function (pred__23421,expr__23422){
return (function (p1__23416_SHARP_){
return console.debug(p1__23416_SHARP_);
});
;})(pred__23421,expr__23422))
} else {
if(cljs.core.truth_(pred__23421.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__23422))){
return ((function (pred__23421,expr__23422){
return (function (p1__23417_SHARP_){
return console.error(p1__23417_SHARP_);
});
;})(pred__23421,expr__23422))
} else {
return ((function (pred__23421,expr__23422){
return (function (p1__23418_SHARP_){
return console.log(p1__23418_SHARP_);
});
;})(pred__23421,expr__23422))
}
}
...
var eval_fn = cljs.core.get.call(null,map__23426__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__23428_SHARP_);
});})(new_def))
);
...
return (function (p__23429){
var vec__23430 = p__23429;
var ky = cljs.core.nth.call(null,vec__23430,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1571428111795
